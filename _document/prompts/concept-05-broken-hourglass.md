...
NEGATIVE: see §5, PLUS: no explosive shattering, no violent glass-break, no sharp-edged shards flying at velocity, no bloom halo, no starburst reflections, no red anywhere, no cyan, no lens flare, no camera motion of any kind.
...
```
This handoff-hourglass-7.png becomes the basis for `story-hourglass-poster.jpg` after the merge (§3).

---

## 3. Post-generation ffmpeg merge (7 clips → `story-hourglass.mp4`)
...
## 6. QA checklist — Concept 05 continuity + canon compliance
